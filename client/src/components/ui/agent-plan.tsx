...
export default function Plan({ initialTasks = [] }: PlanProps) {
  ...
  useEffect(() => {
    ...
    if (initialTasks.length > 0) {
      setExpandedTasks([initialTasks[0].id]);
    }
  }, [initialTasks]);
  ...
  return (
    <div className="bg-transparent text-foreground h-full overflow-auto p-2">
      <motion.div 
        className="bg-card/80 backdrop-blur-md border-border rounded-lg border shadow overflow-hidden"

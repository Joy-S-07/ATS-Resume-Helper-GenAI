                    ...
                    <div style={{ animation: "slide-up 0.8s ease 0.15s both" }}>
                        <div className="rounded-3xl" style={{ padding: "32px", background: "rgba(10,10,10,0.7)", backdropFilter: "blur(40px)", border: "1px solid rgba(255,255,255,0.07)", boxShadow: "0 25px 50px -12px rgba(0,0,0,0.6)" }}>
                            ...
                            <div className="flex p-1 rounded-xl mb-7" style={{ background: "rgba(255,255,255,0.04)", padding: "4px" }}>
                                <Link to="/login" className="flex-1 rounded-lg text-sm font-medium text-center" style={{ padding: "10px 0", background: "transparent", color: "rgba(255,255,255,0.4)", textDecoration: "none", fontFamily: "'DM Sans', sans-serif" }}>Sign In</Link>
                                <div className="flex-1 rounded-lg text-sm font-medium text-center" style={{ padding: "10px 0", background: "rgba(39,243,169,0.12)", color: "#27F3A9", fontFamily: "'DM Sans', sans-serif", border: "1px solid rgba(39,243,169,0.15)" }}>Create Account</div>
                            </div>

                            <div className="mb-6">
                                <h2 style={{ fontFamily: "'Syne', sans-serif", fontWeight: 700, fontSize: 24, color: "#fff", letterSpacing: "-0.5px", marginBottom: 4 }}>Get started free</h2>
                                <p className="text-sm" style={{ color: "rgba(255,255,255,0.4)" }}>Join 50,000+ job seekers using AI</p>
                            </div>
                            ...
                            <form onSubmit={handleSubmit} className="flex flex-col gap-4 mt-1">
                                <div>
                                    <label className="block text-[13px] font-medium mb-1.5" style={{ color: "rgba(255,255,255,0.6)" }}>Full Name</label>
                                ...
                                <div>
                                    <label className="block text-[13px] font-medium mb-1.5" style={{ color: "rgba(255,255,255,0.6)" }}>Password</label>
                                ...
                                <div className="flex gap-2.5 p-3 rounded-xl" style={{ background: "rgba(39,243,169,0.05)", border: "1px solid rgba(39,243,169,0.12)" }}>
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#27F3A9" strokeWidth="2" strokeLinecap="round" style={{ flexShrink: 0, marginTop: 1 }}><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
                                    <span className="text-[12px] leading-relaxed" style={{ color: "rgba(255,255,255,0.45)" }}>Free plan includes 5 resume analyses/month & 1 AI-generated resume.</span>
                                </div>

                                <button type="submit" disabled={loading}
                                    className="w-full py-3.5 h-[48px] rounded-xl font-bold text-base relative overflow-hidden mt-1 transition-all duration-300 hover:shadow-[0_8px_30px_rgba(39,243,169,0.25)] hover:-translate-y-0.5 active:translate-y-0"
